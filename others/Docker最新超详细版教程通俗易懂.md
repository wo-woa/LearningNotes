...
docker使用分层下载，如果已经安装了最新版的mysql，再安装mysql5.7，那么前面几层就不需要再下载
...
[root@iz2zeak7sgj6i7hrb2g862z ~]# docker rmi -f f19c56ce 92a8
...
说明：我们有了镜像才可以创建容器，Linux，下载centos镜像来学 习
...
![image-20200 515132913888](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2NoZW5nY29kZXgvY2xvdWRpbWcvbWFzdGVyL2ltZy9pbWFnZS0yMDIwMDUxNTEzMjkxMzg4OC5wbmc?x-oss-process=image/format.png)
...
root@aa664b0c8ed 9:/# whereis nginx	#找到nginx位置
...
**问题**:我们以后要部署项目，如果每次都要进入容器是不是十分麻烦？要是可以在容器外部提供一个映射路径，比如webapps，  了！
...
81753869c4fd438cec0e31659cbed0d112ad22bbcfcb9605 483b126ee8ff306d
```
